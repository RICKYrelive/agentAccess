          ...
          <div v-if="form.category === 'team'" class="space-y-3">
            ...
            <div>
              ...
              <input
                ...
                type="text"
                placeholder="搜索团队..."
                class="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-green-500"
              />
            </div>
...
import type { TextImportForm, TeamSharingPermission, KnowledgeBaseCategory } from '@/types/knowledge-base'
...
const handleSubmit = () => {
  ...
  const submitForm: TextImportForm = { ...form.value }
