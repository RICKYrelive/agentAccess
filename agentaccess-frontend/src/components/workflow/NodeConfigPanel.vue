<template>
  <div class="bg-white h-full flex flex-col">
      ...
      <div v-else>
        ...
        <div v-if="node.type === 'input'" class="space-y-3 pt-4 border-t border-gray-200">
          ...
          <div>
            ...
            <select v-model="localConfig.inputType" class="input-field" @change="updateConfiguration">
        ...
        <div v-if="node.type === 'web-search'" class="space-y-3 pt-4 border-t border-gray-200">
          ...
          <div>
            ...
            <select v-model="localConfig.searchEngine" class="input-field" @change="updateConfiguration">
        ...
        <div v-if="node.type === 'question-rewrite'" class="space-y-3 pt-4 border-t border-gray-200">
        ...
        <div v-if="node.type === 'knowledge-retrieval'" class="space-y-3 pt-4 border-t border-gray-200">
          ...
          <div>
            ...
            <select v-model="localConfig.retrievalMode" class="input-field" @change="updateConfiguration">
        ...
        <div v-if="node.type === 'data-processing'" class="space-y-3 pt-4 border-t border-gray-200">
          ...
          <div>
            ...
            <select v-model="localConfig.operation" class="input-field" @change="updateConfiguration">
        ...
        <div v-if="node.type === 'condition'" class="space-y-3 pt-4 border-t border-gray-200">
          ...
          <div>
            ...
            <select v-model="localConfig.conditionType" class="input-field" @change="updateConfiguration">
        ...
        <div v-if="node.type === 'code-execution'" class="space-y-3 pt-4 border-t border-gray-200">
          ...
          <div>
            ...
            <select v-model="localConfig.language" class="input-field" @change="updateConfiguration">
        ...
        <div v-if="node.type === 'output'" class="space-y-3 pt-4 border-t border-gray-200">
          ...
          <div>
            ...
            <select v-model="localConfig.outputType" class="input-field" @change="updateConfiguration">
        ...
        <div v-if="node.type === 'annotated-data-retrieval'" class="space-y-3 pt-4 border-t border-gray-200">
          ...
          <div>
            ...
            <select v-model="localConfig.retrievalStrategy" class="input-field" @change="updateConfiguration">
    ...
    <!-- Actions -->
    <div v-if="node && node.type !== 'start' && node.type !== 'end'" class="px-4 py-3 border-t border-gray-200">
