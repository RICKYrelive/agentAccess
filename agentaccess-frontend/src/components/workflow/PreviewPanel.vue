  ...
  <div class="h-full bg-white flex flex-col">
    ...
    <div class="p-4 border-b border-gray-200">
      ...
      <div
        ...
        class="mb-2 flex items-center space-x-2 text-xs text-green-600"
      >
      ...
      <div class="flex space-x-2">
        <input
          ...
          :disabled="isRunning"
        />
        <button @click="runTest" :disabled="!testInput.trim() || isRunning" class="btn-primary">
          {{ isRunning ? '运行中...' : '运行测试' }}
        </button>
      </div>
    </div>
        ...
        >
          ...
          <div class="p-4 space-y-4">
                ...
                >
                  <div class="flex items-start justify-between">
                    <div class="flex-1">
                      ...
                      <p class="text-xs text-yellow-700 mt-1">来源: {{ material.source }}</p>
            ...
            <div v-if="test.status === 'failed'">
              <label class="block text-xs font-medium text-red-700 mb-1"> 错误信息 </label>
